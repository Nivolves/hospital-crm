...
export const TYPICAL_IMAGES = {
  convex: [
    { image: convexNorm, name: 'Норма' },
    { image: convexPatology, name: 'Патологія' },
    { image: convexStrangeNorm, name: 'Не визначено' },
  ],
  linear: [
    { image: linearNorm, name: 'Норма' },
    { image: linearPatology, name: 'Патологія' },
    { image: linearStrangeNorm, name: 'Не визначено' },
  ],
  reinforced_linear: [
    { image: reinforcedNorm, name: 'Норма' },
    { image: reinforcedPatology, name: 'Патологія' },
    { image: reinforcedStrangeNorm, name: 'Не визначено' },
  ],
};
